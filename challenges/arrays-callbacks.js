...
let populationTotal = zooAnimals.reduce(cb(acc,item,){
...
console.log(add(consume(8+5)))

function mult(callback){
  return callback(a*b)
  }
  console.log(mult(consume(8+5)))

function greeting(callback){
  return callback(`Hello ${a}${b}, nice to meet you`)
  }
  console.log(greeting(consume(Jelly,Fish)))
